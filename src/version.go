...
const (
	...
	// logoURL is the vendor's own mark. CPA exposes pluginapi.Metadata.Logo to
	// management clients and the plugin store reads the matching "logo" key from
	// registry.json, so the same asset is used in both places.
	logoURL = "https://freebuff.com/logo-icon.png"
